...
bot.hears('📞 Позвонить в колл-центр', (ctx) => {
    // If the message text is "Call"
    ctx.reply('Do you want to make a call?', Markup.inlineKeyboard(
        [Markup.button.url('Позвонить в колл-центр', 'http://64.23.175.160/?call=true')]
        )
    );
